# Android 13 for the PinePhonePro based on the GloDroid project

[![GloDroid](https://img.shields.io/badge/GLODROID-PROJECT-blue)](https://github.com/GloDroid/glodroid_manifest)
[![ProjectStatus](https://img.shields.io/badge/PROJECT-STATUS-yellowgreen)](https://github.com/GloDroidCommunity/pine64-pinephonepro/issues/1)
...
Find the sdcard image or archive with fastboot images [here](https://github.com/GloDroidCommunity/pine64-pinephonepro/releases)
...
```bash
git clone https://github.com/GloDroidCommunity/pine64-pinephonepro.git
cd pine64-pinephonepro
```
